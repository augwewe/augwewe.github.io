...
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221119171231536.png" alt="image-20221119171231536" loading="lazy"></p>
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221119171113993.png" alt="image-20221119171113993" style="zoom: 67%;" />
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221119171549635.png" alt="image-20221119171549635" style="zoom: 67%;" />
...
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221119171753590.png" alt="image-20221119171753590" style="zoom:50%;" />
...
<p>每一层都取完再取下一层</p>
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221119221146502.png" alt="image-20221119221146502" style="zoom:50%;" />
<p><strong>深度优先算法</strong></p>
<p>从开始取到最后一个节点</p>
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221119221250774.png" alt="image-20221119221250774" style="zoom:50%;" />
<h3 id="ajax" tabindex="-1"><a class="header-anchor" href="#ajax" aria-hidden="true">#</a> ajax</h3>
<p>百度搜索图片<img src="@source/Blog/2022/Crawl/foundation/PythonCrawl.assets/image-20221120181835251.png" alt="image-20221120181835251" style="zoom:50%;" /></p>
<p>往下滑动的同时，会看到左边数据有增加，但是页面并不会改变</p>
<h3 id="字体反爬虫" tabindex="-1"><a class="header-anchor" href="#字体反爬虫" aria-hidden="true">#</a> 字体反爬虫</h3>
<p>实习僧网页：</p>
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221120182927938.png" alt="image-20221120182927938" style="zoom:50%;" />
...
<p><strong>1.URL和URI</strong>，基本相等</p>
<p>豆瓣有自己的图标，指向唯一访问模式</p>
<p>查看图标方式：网址+favicon.ico</p>
<p>如下图所示</p>
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221120183346849.png" alt="image-20221120183346849" style="zoom:50%;" />
...
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221120205744260.png" alt="image-20221120205744260" style="zoom:50%;" />
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221120205815329.png" alt="image-20221120205815329"  />
...
<p>第四列 Initiator：请求源。用来标记请求是由哪个对象或进程发起的。</p>
<p>第五列 Size：从服务器下载的文件和请求的资源大小。如果是从缓存中取得的资源，则该列会显示 from cache。</p>
<p>第六列 Time：发起请求到获取响应所用的总时间。</p>
...
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221120213922697.png" alt="image-20221120213922697" style="zoom: 50%;" />
...
<p>Host：用于指定请求资源的主机 IP 和端口号，其内容为请求 URL 的原始服务器或网关的位置。从 HTTP 1.1 版本开始，请求必须包含此内容。</p>
<p>Cookie：也常用复数形式 Cookies，这是网站为了辨别用户进行会话跟踪而存储在用户本地的数据。它的主要功能是维持当前访问会话。例如，我们输入用户名和密码成功登录某个网站后，服务器会用会话保存登录状态信息，后面我们每次刷新或请求该站点的其他页面时，会发现都是登录状态，这就是 Cookies 的功劳。Cookies 里有信息标识了我们所对应的服务器的会话，每次浏览器在请求该站点的页面时，都会在请求头中加上 Cookies 并将其发送给服务器，服务器通过 Cookies 识别出是我们自己，并且查出当前状态是登录状态，所以返回结果就是登录之后才能看到的网页内容。</p>
...
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/Cgq2xl5XTQSAfWsUAAa-jFIsTTw064.2d57e938.png" alt="img" style="zoom: 33%;" />
...
<p>浏览器缓存</p>
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221121002817352.png" alt="image-20221121002817352" loading="lazy"></p>
<h3 id="页面呈现" tabindex="-1"><a class="header-anchor" href="#页面呈现" aria-hidden="true">#</a> 页面呈现</h3>
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221121005418250.png" alt="image-20221121005418250" loading="lazy"></p>
...
<p>案例1：</p>
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221121175216475.png" alt="image-20221121175216475" loading="lazy"></p>
<p>案例2：</p>
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221121175353470.png" alt="image-20221121175353470" loading="lazy"></p>
<p><strong>点击上下箭头检查匹配的内容</strong></p>
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221121175421903.png" alt="image-20221121175421903" loading="lazy"></p>
...
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221122150529578.png" alt="image-20221122150529578" style="zoom:67%;" />
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221122150602191.png" alt="image-20221122150602191" loading="lazy"></p>
<p>一秒钟运行一个线程（一个程序）</p>
...
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221122151935405.png" alt="image-20221122151935405" loading="lazy"></p>
<h3 id="多线程" tabindex="-1"><a class="header-anchor" href="#多线程" aria-hidden="true">#</a> 多线程</h3>
<p><img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221122154327669.png" alt="image-20221122154327669" loading="lazy"></p>
...
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221122160228431.png" alt="image-20221122160228431" style="zoom:50%;" />
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为 count 这个值是共享的，每个线程都可以在执行 temp = count 这行代码时拿到当前 count 的值，但是这些线程中的一些线程可能是并发或者并行执行的，这就导致不同的线程拿到的可能是同一个 count 值，最后导致有些线程的 count 的加 1 操作并没有生效，导致最后的结果偏小。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="多进程" tabindex="-1"><a class="header-anchor" href="#多进程" aria-hidden="true">#</a> 多进程</h3>
<p>回顾：一个进程中有多个线程，同一时刻只能有一个线程运行，在python中的多线程并不能完全发挥多核优势。</p>
<p>对于多进程来说，每个进程都有属于自己的GIL,多进程运行不受GIL影响，所以它能更好地发挥多核 的优势。</p>
<p>1.创建进程比较消耗资源</p>
<p>2.多线程和多进程相互结合比较适合大型爬虫项目</p>
<p>3.多进程的好处，多进程中多个线程可以同时运行</p>
<p><strong>4.多进程是并发执行</strong></p>
...
<img src="@source/Blog/2022/Crawl/PythonCrawl.assets/image-20221125103423866.png" alt="image-20221125103423866" style="zoom: 67%;" />
