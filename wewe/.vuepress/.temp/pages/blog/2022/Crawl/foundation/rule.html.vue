...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>content<span class="token operator">=</span><span class="token string">"Hello 123 4567 Word_This is a Regex Demo"</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>content<span class="token operator">=</span><span class="token triple-quoted-string string">'''Hello 1234567 Word_This
is a Regex Demo
'''</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment">#groups()返回元组</span>
content<span class="token operator">=</span><span class="token string">"Hello 123 4567 Word_This is a Regex Demo"</span>
pattern<span class="token operator">=</span><span class="token string">"^H.*\s(\d+)\s.*Demo$"</span><span class="token comment">#</span>
result<span class="token operator">=</span>re<span class="token punctuation">.</span><span class="token keyword">match</span><span class="token punctuation">(</span>pattern<span class="token punctuation">,</span>content<span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span>result<span class="token punctuation">)</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment">#转义</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment">#search方法,不会因原字符开头和结尾不符合匹配而影响到结果</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment">#sub，替换所有符合条件的 。2.将匹配的条件用括号引用，r'1\加上添加的内容',</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s1<span class="token operator">=</span><span class="token string">'&lt;link rel="search" href="https://www.baidu.com"/> '</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>s2<span class="token operator">=</span><span class="token string">"&lt;groupId>QDReader.QDAarCenter&lt;/groupId>"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> xlrd<span class="token punctuation">,</span>xlwt<span class="token punctuation">,</span>re
...
<h2 id="效果测试" tabindex="-1"><a class="header-anchor" href="#效果测试" aria-hidden="true">#</a> 效果测试</h2>
<p>习近平总书记指出，2023年，要坚持稳字当头、稳中求进，更好统筹国内国际两个大局，更好统筹疫情防控和经济社会发展，更好统筹发展和安全，全面深化改革开放，努力实现经济运行整体好转，推动人民生活持续改善。新年头一个月，多项经济先行指标回暖，生产消费供需两旺，中国经济持续回稳向好。
<img src="@source/Blog/2022/Crawl/foundation/rule.assets/137f4710123bd86e8a2094d42629aacb6465ce2e.png" style="display: block; margin: auto;" />
...
今天的中国，充满生机与活力。新的一年，尽管国际环境风高浪急，但中国经济长期向好的基本面依然不变，只要笃定信心、团结奋斗，就一定能实现稳中有进、高质量发展的既定目标。</p>
<h3 id="没有span" tabindex="-1"><a class="header-anchor" href="#没有span" aria-hidden="true">#</a> 没有span</h3>
<p>习近平总书记指出，2023年，要坚持稳字当头、稳中求进，更好统筹国内国际两个大局，更好统筹疫情防控和经济社会发展，更好统筹发展和安全，全面深化改革开放，努力实现经济运行整体好转，推动人民生活持续改善。新年头一个月，多项经济先行指标回暖，生产消费供需两旺，中国经济持续回稳向好。
<img src="//img1.bjd.com.cn/2023/02/04/137f4710123bd86e8a2094d42629aacb6465ce2e.png" style="display: block; margin: auto;" />
新春年味未消，一系列经济指标已经火热出炉。1月份中国制造业采购经理指数PMI为50.1%，环比上升3.1个百分点，在三个月后重新回到扩张区间。
2022年12月，习近平总书记在中央经济工作会议上发表重要讲话，为中国经济发展指明方向。会议指出，我国经济韧性强、潜力大、活力足，各项政策效果持续显现，2023年经济运行有望总体回升。
国家信息中心的大数据分析发现，全国100个有代表性的科技孵化器周边平均人流量，今年1月比去年12月增长了17.6%，比2022年同期增长了8.5%，表明众多科创型企业已出现明显回暖势头。
<img src="@source/Blog/2022/Crawl/foundation/rule.assets/b74c14758e3b47e418a5db239a7f0bb2ebc38cb1-1675484257313-13.png" style="display: block; margin: auto;" />
项目中标量数据对普通人来说可能略显陌生，但却直接反映企业投资冷暖。监测显示，1月份全国项目中标数量同比增速达到32.2%，中部地区增速最高，达到45.7%。
新年新作为，新年新气象。
<img src="//img1.bjd.com.cn/2023/02/04/e8da183a13ac47d8cffc49a8ff66afecbbd1ff0c.png" style="display: block; margin: auto;" />
向实，实体经济发展势头更稳，后劲更足。农业春耕备耕播种希望，提升全年粮食稳定供应能力。工业订单充足，人机繁忙。今年1月，制造业21个行业中有18个景气度较上月上升，高技术制造业、装备制造业投资增速迅猛，服务业加速向中高端不断升级。
...
<img src="//img1.bjd.com.cn/2023/02/04/ef941dc75329368b7a19a3e42adab4aa8069be03.png" style="display: block; margin: auto;" />
今天的中国，充满生机与活力。新的一年，尽管国际环境风高浪急，但中国经济长期向好的基本面依然不变，只要笃定信心、团结奋斗，就一定能实现稳中有进、高质量发展的既定目标。</p>
<h2 id="中国日报测试" tabindex="-1"><a class="header-anchor" href="#中国日报测试" aria-hidden="true">#</a> 中国日报测试</h2>
<p>1月31日下午，习近平总书记在中央政治局第二次集体学习时强调，只有加快构建新发展格局，才能夯实我国经济发展的根基、增强发展的安全性稳定性，才能在各种可以预见和难以预见的狂风暴雨、惊涛骇浪中增强我国的生存力、竞争力、发展力、持续力，确保中华民族伟大复兴进程不被迟滞甚至中断，胜利实现全面建成社会主义现代化强国目标。党的十八大以来，以习近平同志为核心的党中央统筹发展、安全和稳定，高度重视发展的安全性与稳定性问题，增强忧患意识，做到居安思危。今天，党建网梳理了习近平总书记的部分相关重要论述，与您一同学习领会。</p>
 <img src="@source/Blog/2022/Crawl/foundation/rule.assets/63dd00a7a3102ada7c832b1b.png" data-from="newsroom" data-mimetype="image/png" id="img-63dd00a7a3102ada7c832b1b"> 
<p><span style="font-size: 16px; background-color: #ffffff;">2021年10月26日，习近平在北京展览馆参观国家“十三五”科技创新成就展。新华社记者 谢环驰 摄</span></p>
<p>只有加快构建新发展格局，才能夯实我国经济发展的根基、增强发展的安全性稳定性
...
——2023年1月31日，习近平在中央政治局第二次集体学习时的讲话</p>
 <img src="@source/Blog/2022/Crawl/foundation/rule.assets/63dd00a7a3102ada7c832b1f.png" data-from="newsroom" data-mimetype="image/png" id="img-63dd00a7a3102ada7c832b1f"> 
<p><span style="font-size: 16px; background-color: #ffffff;">2020年10月14日，深圳经济特区建立40周年庆祝大会在广东省深圳市隆重举行。习近平在会上发表重要讲话。新华社记者张领 摄</span></p>
<p>牢牢守住安全发展这条底线，是构建新发展格局的重要前提和保障
...
——2022年10月16日，习近平在中国共产党第二十次全国代表大会上的报告</p>
 <img src="@source/Blog/2022/Crawl/foundation/rule.assets/63dd00a7a3102ada7c832b21.png" data-from="newsroom" data-mimetype="image/png" id="img-63dd00a7a3102ada7c832b21"> 
<p>2021年1月11日，省部级主要领导干部学习贯彻党的十九届五中全会精神专题研讨班在中央党校（国家行政学院）开班。习近平在开班式上发表重要讲话。新华社记者 鞠鹏 摄
...
阿联酋华星艺术团团长王鸣凤表示，阿联酋华星艺术团组成了腰鼓队方阵，在春节巡游中英姿飒爽，腰鼓队中的成员年龄最小的10岁，年龄最大的72岁。“‘欢乐春节’大巡游不仅是阿联酋华侨华人的一道年味大餐，也是一场当地民众共同参与的文化盛宴，向阿联酋乃至全世界展示了中华传统文化。”</p>
<pre><code>        （吴）
</code></pre>
<hr>
<img src="@source/Blog/2022/Crawl/foundation/rule.assets/63e07991a3102ada7c833721.png" data-from="newsroom" data-mimetype="image/png" id="img-63e07991a3102ada7c833721"> 
<p>何为中国？何以中国？无声文物记录着中华文明的恢弘气象，诉说着中华文化的起承转合。“人民昌·中国强”汉代铜镜，是迄今发现的唯一带有“人民昌”“中国强”吉语铭文的铜镜，进一步佐证了汉代“中国”国家观念的形成。
...
<hr>
<img src="@source/Blog/2022/Crawl/foundation/rule.assets/63dfb4c0a3102ada7c8333ef.png" data-from="newsroom" data-mimetype="image/png" id="img-63dfb4c0a3102ada7c8333ef"> 
<p>央视网消息：正月十五月儿圆、闹花灯。正如诗词所说“谁家见月能闲坐？何处闻灯不看来？”各地各式的花灯星星点点，流光溢彩，美轮美奂。</p>
<p>标题: “欢乐春节”为多国奉上中华文化年货 - 中国日报网
...
省发改委重大项目办以问题为导向，强化包联企业工作，切实解决项目推进的痛点和难点，让项目能够顺利、高速地推进。目前，全省在建省级重点项目，62个项目具备2月底前复工条件，150个项目3月底前、超过500个项目4月底前可实现开复工。（记者 吴利红 见习记者 杨惠暄）</p>
<pre><code>        （吴利红）
</code></pre>
<hr>
<p>实干是我们党的优良传统。
...
<img src="@source/Blog/2022/Crawl/foundation/rule.assets/63dfb476a3102ada7c8333e9.png" data-from="newsroom" data-mimetype="image/png" id="img-63dfb476a3102ada7c8333e9"></p>
<p>天津港，通达世界180多个国家和地区的500多个港口，是“一带一路”的海陆交汇点和服务全面对外开放的国际枢纽港。
<img src="@source/Blog/2022/Crawl/foundation/rule.assets/63dfb05de4b0f0edae80f3c2.jpg" width="443" height="249" data-resourcesrc="/capital/image/202302/05/63dfb05de4b0f0edae80f3c2.jpg" data-from="dams" data-damsstoid="po63dfb05de4b0f0edae80f3c3" data-damslibid="capital" data-width="1000" data-height="563" id="img-63dfb05de4b0f0edae80f3c2">
...
联合出品</p>
<hr>
<p>中新网上海2月5日电 题：为何此般“闹”元宵节？小习俗传承千年记忆</p>
<p>作者谢梦圆</p>
<p>“这个兔子身上为什么有那么多花纹啊？而且还会亮，好漂亮啊！”6岁的小秋指着悬挂的彩色兔子灯好奇地问身边的妈妈。5日，赏花灯、猜灯谜、包汤圆等元宵活动在上海市浦东新区群众文化艺术馆举行，现场上百个造型各异的花灯组成一片流光璀璨的花灯长廊吸引不少带孩子的家长驻足拍照留影。</p>
<p>一旁的灯谜架上红纸片随风翻飞，纸上写着灯谜，辅以隐隐透出亮光的大红灯笼图案作为装饰。架子顶端每隔一段距离就伸出一根近一米的杆子，每根杆子上依次挂着两个纯色纸灯笼和一个兔子灯。兔子灯憨态可掬的模样引得孩子们纷纷仰头盯着看。</p>
<p>为什么元宵节一定要看花灯？</p>
...
<p>之后这种全民习俗又演变成了社会性的庆典活动。到了隋唐时期，一些统治者比较提倡看花灯的风俗，尤其是唐宋的统治阶级，甚至会发布放假政策。上行下效，至少到了南宋时期，元宵节已经成为盛大的、全民狂欢的活动了。</p>
<blockquote>
<img title="上海市浦东新区群众文化艺术馆的文化广场中，一个孩子在玩可以拖动的兔子灯 谢梦圆 摄" src="@source/Blog/2022/Crawl/foundation/rule.assets/008f0de8-4ce3-4b22-9305-d5c571a96dfc_zsite-1675677961065-37.jpeg" alt="上海市浦东新区群众文化艺术馆的文化广场中，一个孩子在玩可以拖动的兔子灯 谢梦圆 摄" />
</blockquote>
<h2 id="中国教育新闻网" tabindex="-1"><a class="header-anchor" href="#中国教育新闻网" aria-hidden="true">#</a> 中国教育新闻网</h2>
<p>2月6日，在山东省青岛市李沧区崇礼小学，学生正在体验剪纸。张鹰 摄&quot; /&gt;
<img src="@source/Blog/2022/Crawl/foundation/rule.assets/P020230207306128186266.jpg" /></p>
<pre><code>                2月6日，在安徽省淮北市第三实验小学，学生们在语文课上朗读课文。万善朝 摄&quot; /&gt;
            &lt;img src=&quot;http://www.jyb.cn/rmtzgjyb/202302/P020230207306128450581.jpg&quot; /&gt;
</code></pre>
<p>​</p>
<pre><code>        本报北京2月6日综合消息（记者黄鹏举孙军）今天，河北、安徽、山东、浙江、湖南、重庆等地中小学和幼儿园迎来2023年春季学期开学。各地用精心筹划的欢迎仪式、多彩的活动开启新学期。山东省青岛市120万名中小学生今天迎来新学期。卡通兔子在学校门前迎接学生，元宵节的灯笼装扮美化校园……青岛市李沧区崇礼小学开展“非遗进校园”活动，学生们通过剪纸、皮影戏、手绘制作风筝等非物质文化遗产项目，感受传统文化魅力。浙江省台州市仙居县第一小学举行拔河、跳绳、老鹰捉小鸡等趣味活动，让学生们在快乐运动中迎接新学期。新学期伊始，河北省邢台市隆尧县教育部门在多所小学、幼儿园组织开展“开学第一课安全进校园”主题活动。消防救援人员、交警走入校园，通过主题班会、现场讲座等方式讲解各类人身安全保护知识，以增强少年儿童自我安全保护意识。《中国教育报》2023年02月07日第1版
</code></pre>
<hr>
<p>​            日前，浙江省教育厅向全省各地教育局发出提示函，严禁提前组织学生返校集中补课、组织任何形式的开学考试，要求重点做好开学前后的家校沟通，做细做好延期考试的学生考前心理疏导和考试组织，合理降低对学有困难学生的作业要求，允许缓交寒假作业，帮助学生平稳度过开学过渡期。可以说，该提示函的发出是非常及时的，体现了健康第一、以生为本的教育理念。有数据统计发现，近期各地因“开学焦虑”问题而进行心理求助的学生正在增加，问题的复杂程度也高于往年同期，需要引起学校和家长的重视。“放假—开学”本是学生最习以为常的校园生活模式，但在经历了上学期长时间居家网课、新冠病毒感染、期末考试调整以及超长寒假等之后，新学期的开学就显得非同寻常。因而，学校该如何安排开学前后的准备工作、家长该如何帮助孩子收心向学、学生又该以怎样的方式开启新生活，成为本阶段看似老生常谈却富有全新挑战的重要话题。总体而言，除了必要的条件保障准备外，学校和家长要重点从情绪引导与心理支持的角度，帮助学生做好迎接新学期的心态调整和心理建设工作。就学校而言，要为开学后将出现长于往年的过渡期而提前做好准备，以“三退”求“三进”。“三退”是指过渡期里，校园常规要求倒退一步，容许学生线下学习规范的再养成；教学进度安排后退一步，支持学生新旧知识衔接的再强化；家校沟通主题后退一步，重启学生家庭基本状况、亲子关系和重大事件的再摸排。根据心理发展规律，新适应的形成至少需要21天，因此可以将开学后的第一个月设置为“重新适应”主题月，从而把在开学前就要求学生做好的身心和学业准备推迟到开学后的三四周内完成。这样的安排及时传达给学生后，能大大缓解焦虑情绪。而精心准备、合理安排下的“三个后退一步”还将为全体学生利用过渡期取得学习习惯、知识掌握和人格成长上的“三个更进一步”创造契机。为此，学校可以在开学前采用线上热身班会、吐槽小会、云聊天、电话家访等自由轻松的形式，引导学生回顾在校和居家学习的切身体验，总结个人得失，为构建高效学习模式做好准备；支持学生巩固加强混合学习的技能技巧，为继续用好线上线下资源开展自主学习打下基础；鼓励学生分享居家学习期间对家庭、国家、社会和生命价值的思考与感悟，为人格上的成长升华积累养分。就家长而言，要密切关注和科学回应孩子的情绪反应与心理变化，有所为有所不为。可以适当向孩子表达自身情绪，但不要宣泄情绪。有些孩子居家学习效果不佳、寒假作业进展缓慢，家长看在眼里急在心里。此时，家长可以适当表达自己的焦虑以唤起孩子对问题的重视，但不可把孩子当成肆意宣泄情绪的出口。情绪宣泄不仅会把不良情绪传递给孩子，而且会放大紧张焦虑的情绪反应，激化孩子对上学的抵触和逃避心理。一旦发现孩子出现情绪不稳定、睡眠不好、忧心忡忡、拖延磨蹭、无来由的身体不适等，要及时提供心理支持与帮助，不能视而不见或横加指责。家长要以同理心站在孩子的角度看待其当前面临的压力，科学表达自己的认同与理解，引导孩子倾诉内心的感受，并与孩子一起分析问题根源、探寻解决途径。当家庭力量无法解决时，要及时向心理教师或专业机构寻求帮助。此外，面对不同年龄阶段和性格特点的孩子，要因人而异，采取适宜的亲情表达方式，避免好心办坏事。比如，对于小学生，家长主动指导寒假作业、憧憬规划新学期生活、一起准备学习用品、帮孩子实现假期愿望等都是行之有效的好做法。但对于正值青春期的中学生，家长的主动介入与干预却可能适得其反。此时更需要家长以积极共情、信任尊重、以身示范、非说教表达等方式给予心理支持。需要强调的是，无论学校还是家长，都要树立学生是自身成长第一责任人的观念，协助和支持学生充分发挥自身主体作用，使其在困难与挑战的磨砺中不断优化心理建设，成为自己身心健康的主人。（作者系中国教育科学研究院副研究员）《中国教育报》2023年02月07日第2版</p>
<hr>
<p>​            <img class="app_image" imagesource="personal" meiziid="62524" relationid="62532" src="@source/Blog/2022/Crawl/foundation/W020230201393898802233.png" style="display: block; clear: both; margin: 0px auto; max-width: 640px;" type="app_image" oldsrc="W020230201393898802233.png" /><span type="imagenote" class="imagenotePlace"></span></p>
<hr>
<p>中新网2月8日电 据国家发展改革委微信公众号消息，《横琴粤澳深度合作区发展促进条例》公布。条例自2023年3月1日起施行。</p>
<p>横琴粤澳深度合作区发展促进条例</p>
<p>(2023年1月9日广东省第十三届人民代表大会常务委员会第四十八次会议通过)</p>
<p>第一章  总  则</p>
<p>第一条  为了推动横琴粤澳深度合作区(以下简称合作区)建设，促进澳门经济适度多元发展，丰富“一国两制”实践，根据《横琴粤澳深度合作区建设总体方案》(以下简称《总体方案》)和有关法律、行政法规，制定本条例。</p>
<p>第二条  本条例适用于合作区建设和发展促进等活动。</p>
<p>本条例的适用范围为《总体方案》中确定的横琴岛“一线”和“二线”之间的海关监管区域，不包括澳门大学横琴校区和横琴口岸澳门管辖区。横琴与澳门之间为“一线”，横琴与中华人民共和国关境内其他地区(以下简称内地)之间为“二线”。</p>
<p>第三条  合作区建设应当坚持解放思想、改革创新、互利合作、开放包容，发展促进澳门经济适度多元的新产业，建设便利澳门居民生活就业的新家园，构建与澳门一体化高水平开放的新体系，健全粤澳共商共建共管共享的新体制，推动澳门长期繁荣稳定和更好融入国家发展大局。</p>
<p>第四条  广东省人民政府及其有关部门、珠海市人民政府及其有关部门应当根据合作区开发建设实际，将有关省、市管理权限依法授权或者委托给合作区有关机构行使。</p>
<p>广东省人民政府及其有关部门应当结合自身职能制定措施，加大对合作区指导支持力度，把合作区作为深化改革、扩大开放的试验田和先行区。</p>
<p>广东省其他地区已经推行的改革举措，合作区具备条件且有实际需要的，广东省人民政府及其有关部门应当支持合作区探索实施。</p>
<p>支持合作区以清单式申请授权方式，在经济管理、营商环境、市场监管等重点领域深化改革、扩大开放。</p>
<p>第五条  合作区率先在改革开放重要领域和关键环节大胆创新、先行先试、自主探索，推进规则衔接、机制对接，打造具有中国特色、彰显“一国两制”优势的区域开发示范。</p>
<p>合作区建立容错免责机制。在合作区进行的改革创新未能实现预期目标，但是符合合作区战略定位和任务要求，决策程序符合法律、法规或者有关规定，未牟取私利或者未恶意串通损害公共利益的，对有关单位和个人免于追究相关责任。</p>
<p>第二章  治理体制</p>
<p>第六条  合作区管理委员会由广东省、澳门特别行政区双方按照《总体方案》联合组建，实行双主任制。广东省和澳门特别行政区有关单位、珠海市人民政府、中央驻粤相关机构是合作区管理委员会的成员单位。</p>
<p>合作区管理委员会是负责合作区开发管理的议事决策机构，统筹决定合作区下列重大事项，其中涉及国家事权的事项应当按照程序报批：</p>
<p>(一)重大规划，包括合作区总体发展规划、国土空间规划、重要专项规划、年度工作总结和计划安排，年度预决算建议草案等。</p>
<p>(二)重大政策，包括需要省人民政府支持的重大政策，需要争取国家支持的产业、财税、人才、通关、创新创业等方面的重大政策，合作区立法建议等。</p>
<p>(三)重大项目，包括合作区的基础设施建设、产业发展和公共服务等领域的重大项目。重大项目的具体标准由合作区管理委员会另行制定。</p>
<p>(四)重要人事任免，包括提出管理委员会副主任建议人选，任免管理委员会秘书处秘书长、副秘书长和执行委员会主任、副主任，以及执行委员会职能设置、工作机构和人员额度等事宜。</p>
<p>合作区管理委员会可以根据合作区实际需要，按照议事决策程序对前款重大事项的具体内容进行调整。</p>
<p>第七条  合作区执行委员会是合作区管理委员会的日常工作机构，承担合作区建设主体执行责任，负责合作区具体开发建设工作，依法履行国际推介、招商引资、产业导入、土地开发、项目建设、教育医疗、文化体育、社会保障等相关行政管理和公共服务职能。</p>
<p>合作区执行委员会及其工作机构是承担合作区经济、民生管理等相关行政管理和公共服务职能的法定机构。</p>
<p>第八条  原中国(广东)自由贸易试验区珠海横琴新区片区管理委员会、原珠海市横琴新区管理委员会及横琴镇人民政府的经济、民生管理等相关行政管理和公共服务职能，由合作区执行委员会及其工作机构承担。</p>
<p>第九条  法律、法规、规章规定由设区的市及以下人民政府及其有关部门行使的经济、民生管理等相关行政管理和公共服务职能，可以由合作区执行委员会及其工作机构行使。</p>
<p>法律、行政法规、国务院部门规章明确由省人民政府及其有关部门行使的经济、民生管理等相关行政管理和公共服务职能，委托给合作区执行委员会及其工作机构行使，法律、行政法规、国务院部门规章明确规定不得委托的除外。</p>
<p>广东省地方性法规、广东省政府规章规定由省人民政府及其有关部门行使的经济、民生管理等相关行政管理和公共服务职能，交由合作区执行委员会及其工作机构行使。</p>
<p>广东省人民政府及其有关部门承接的国家管理职权，经国务院及其有关部门同意后，可以交由合作区执行委员会及其工作机构行使。</p>
<p>第十条  广东省人民政府及其有关部门交由合作区执行委员会及其工作机构行使的行政职权目录，由广东省人民政府制定并向社会公布。</p>
<p>合作区执行委员会及其工作机构的权责清单由合作区执行委员会向社会公布。</p>
<p>第十一条  根据合作区发展实际需要，合作区执行委员会可以自主决定其工作机构聘用的人员及其薪酬标准和福利待遇，建立与绩效目标相适应的薪酬管理制度。</p>
<p>合作区执行委员会可以从境内外专业人士中选聘工作人员，并应当与聘用的人员签订劳动合同。</p>
<p>第十二条  合作区管理委员会和执行委员会的境外工作人员因工作需要知悉国家秘密的，应当报广东省保密行政管理部门批准。合作区执行委员会应当承担具体保密管理工作。</p>
<p>广东省人民政府可以依法授权合作区执行委员会确定国家秘密的密级。</p>
<p>第十三条  中共广东省委、广东省人民政府在合作区设立的派出机构(以下简称广东省派出机构)，负责党的建设、国家安全、刑事司法、社会治安等职能，履行属地管理职能，配合合作区管理委员会和执行委员会推进合作区开发建设。广东省派出机构与合作区执行委员会应当建立重大事项通报、重要工作衔接协同工作机制，加强日常信息互通共享。</p>
<p>广东省人民政府派出机构在职权范围内以自己的名义行使行政管理职权，职权清单经广东省人民政府同意后向社会公布。</p>
<p>广东省人民政府派出机构与合作区执行委员会的职责分工不明确的，由双方协商一致后报合作区管理委员会备案，协商达不成一致意见的，由合作区管理委员会协调解决。</p>
<p>第十四条  合作区管理委员会广东省方面的成员单位应当与合作区执行委员会及其工作机构建立直接工作联系机制，对合作区执行委员会各工作机构给予业务指导支持，协助解决实际问题。</p>
<p>广东省推进粤港澳大湾区建设领导小组办公室应当发挥统筹协调、决策参谋、推动落实的作用，负责协调广东省有关单位支持合作区开发建设。</p>
<p>广东省相关部门应当强化政策支持和资源保障，对涉及合作区的事项创造条件、优先安排。广东省一体化政务服务平台和一体化行政执法平台应当向合作区执行委员会及其工作机构开放。</p>
<p>第十五条  珠海市应当与合作区建立健全长效对接沟通机制，支持、服务和保障合作区开发建设。合作区的社会管理、城市管理和民生事务等，需要珠海市承接的，由合作区和珠海市协商确定，协商达不成一致意见的，由广东省人民政府协调解决。</p>
<p>第十六条  广东省与澳门特别行政区协商建立合作区收益共享机制。</p>
<p>合作区实行一级财政管理，具体办法由广东省人民政府制定。</p>
<p>合作区国有土地使用权出让收入扣除成本后由合作区与珠海市均等共享。</p>
<p>合作区国民经济统计指标数据纳入珠海市统计。</p>
<p>第十七条  合作区执行委员会负责编制合作区预算草案，经合作区管理委员会同意，由广东省人民政府按照程序提请广东省人民代表大会审查批准；预算调整方案和决算草案，经合作区管理委员会同意，由广东省人民政府按照程序提请广东省人民代表大会常务委员会审查批准。</p>
<p>第十八条  广东省审计主管部门依法对合作区开展审计监督。</p>
<p>合作区管理委员会建立廉政审计机制，按照规定对合作区执行委员会及其工作机构开展廉政监督和审计监督。</p>
<p>广东省有关部门与合作区加强廉政审计业务交流，促进沟通协调。</p>
<p>第十九条  合作区管理委员会建立合作区促进澳门经济适度多元发展成效评估指标体系，开展年度评估。评估结果向粤港澳大湾区建设领导小组报告。</p>
<p>除法律、行政法规和国家规定以外，不得设置对合作区执行委员会及其工作机构的考核、评比等项目。</p>
<p>第三章  规划建设与管理</p>
<p>第二十条  合作区建立以合作区总体发展规划为统领、国土空间规划为基础、专项规划为支撑的规划体系。</p>
<p>合作区开发建设应当符合规划要求，创新建设用地、能耗双控、污染物排放等方面的管理模式。</p>
<p>第二十一条  合作区土地利用应当符合合作区规划，以集约高效、满足长远发展为原则，构建灵活多样的土地供应体系，可以采用长期租赁、先租后让、租让结合、弹性年期供应等方式供应产业用地。新出让建设用地应当直接服务于支持澳门经济适度多元发展。</p>
<p>第二十二条  合作区应当加强基础设施建设，完善岛内综合交通系统，畅通对外联系通道，加强“二线”通道及周边基础设施建设，加强琴澳一体化立体交通体系建设，推动形成布局合理、功能完善、衔接顺畅、运作高效的基础设施网络。</p>
<p>第二十三条  合作区应当依托数字政府基础底座建设城市大数据中心和智慧城市运行管理中心，搭建高效便捷的城市运行管理服务平台，支撑跨部门信息共享和业务协调，实现公共资源智慧化配置。</p>
<p>合作区建立覆盖城市治理、政务服务、社区治理、民生服务等领域的智能化应用体系，加强琴澳智慧城市合作。</p>
<p>第二十四条  合作区应当建立健全地下空间开发利用统筹协调机制，按照安全、高效、适度的原则，加强地下空间分层开发利用。地下空间优先建设交通、市政工程、防空防灾、环境保护等城市基础设施和公共服务设施。</p>
<p>探索城市地下空间竖向开发、分层赋权等土地管理改革创新，在建设用地的地上、地表、地下分别设立使用权。</p>
<p>第二十五条  合作区应当健全生态环境评价和监测监管制度，严守生态保护红线、环境质量底线、资源利用上线，制定生态环境准入清单，落实生态环境分区管控要求，加强植树造林、湿地保育、岸滩改造、海洋生态环境保护等。</p>
<p>合作区应当充分衔接澳门海湾的生态保护与利用，结合城市功能划分滨海岸线类型，形成集湿地生态、城市形象、生活休闲于一体的海湾景观。</p>
<p>第二十六条  合作区应当借鉴国内国际先进经验，提升城市建设和运营管理水平，统筹推进污水管网、固废处理、信息基础、公共文化等公共设施的建设。</p>
<p>支持合作区立足琴澳一体化发展，创新超高层建筑管理模式，在国家规定范围内科学合理设定建筑限高标准。</p>
<p>第二十七条  合作区执行委员会应当会同广东省派出机构成立合作区安全生产委员会，加强安全生产监督管理工作，完善安全生产责任制度，履行安全生产监督管理职责，组织开展较大及以下生产安全事故调查，及时协调解决安全生产监督管理中的重大问题，从源头上防范化解重大安全风险。</p>
<p>广东省对合作区安全生产工作实行单独考核。</p>
<p>第四章  促进产业发展</p>
<p>第二十八条  合作区应当编制产业发展规划，发展促进澳门经济适度多元的新技术、新产业、新业态、新模式，重点发展科技研发和高端制造、中医药、文化旅游会展商贸、现代金融等产业。</p>
<p>合作区可以与澳门公共服务机构合作开展招商活动。</p>
<p>合作区与珠海市建立健全联合招商、收益共享机制，推进产业协同发展。</p>
<p>第二十九条  支持合作区建设发展急需的科技基础设施，引进国内外顶尖科研院所设立重大创新平台，构建技术创新与转化中心，创建国家级重大科研平台，打造粤港澳大湾区国际科技创新中心的重要支点。</p>
<p>第三十条  支持合作区发展集成电路、电子元器件、新材料、新能源、大数据、人工智能、物联网、生物医药产业。</p>
<p>支持合作区构建特色微电子产业链，建设集成电路先进测试技术和服务平台，布局芯片研发和制造项目，建设全球电子元器件集散中心。</p>
<p>支持合作区加快发展数字经济，完善数字基础设施，建设人工智能协同创新生态，开展智能医疗、智能驾驶等领域应用，推动大数据、人工智能、物联网等赋能实体经济和城市发展，打造下一代互联网产业集群。</p>
<p>第三十一条  支持合作区建设中医药生产基地和创新高地，发展中医药服务贸易，建立具有自主知识产权和中国特色的医药创新研发与转化平台。</p>
<p>在合作区生产的经澳门审批和注册的中医药产品、食品及保健食品，可以使用“澳门监造”“澳门监制”“澳门设计”标志。</p>
<p>第三十二条  支持合作区发展休闲养生、康复医疗、健康管理、高端医疗服务等大健康产业。</p>
<p>支持前沿医疗技术研发和应用，推动合作区内具备条件的医疗机构经国家有关部门备案后，开展干细胞、体细胞临床项目研究。支持合作区内医疗机构与已经依法从事干细胞、体细胞等临床研究的内地或者港澳医疗机构加强交流合作，提升临床研究水平和能力。</p>
<p>第三十三条  支持合作区发展休闲度假、会议展览、舞台演艺、体育赛事观光、游艇旅游等文旅产业，高水平建设横琴国际休闲旅游岛。</p>
<p>支持合作区开展国际旅游品牌推广，打造“一程多站”旅游精品线路，推动旅游、文化跨界融合，发展影视、原创艺术、动漫、电竞等文化创意产业。</p>
<p>支持在合作区举办国际高品质消费博览会暨世界湾区论坛。</p>
<p>第三十四条  支持合作区建设高品质进口消费品交易中心、中葡国际贸易中心和数字贸易国际枢纽港。</p>
<p>第三十五条  支持合作区发展银行、证券、保险、私募股权投资等金融业态，支持在合作区创新发展财富管理、债券市场、融资租赁等现代金融业。</p>
<p>鼓励合作区营造与港澳、国际接轨的金融营商环境，探索构建适应合作区高水平开放的金融监管协调机制。</p>
<p>第三十六条  合作区应当制定政策措施，吸引高端人才和紧缺人才参与合作区建设，对引进的高层次人才和重大人才载体给予相应资助和奖励。</p>
<p>支持合作区开展人才发展体制机制综合改革试点，加强与澳门人才计划的衔接，建立与国际规则接轨的人才招聘、评价激励、科研管理等制度。</p>
<p>支持合作区实行更加开放的人才停居留管理措施，实行更加宽松的人员临时出入境政策、便利的工作签证政策。</p>
<p>第三十七条  对合作区内符合国家规定条件的产业企业，减按15%的税率征收企业所得税。对企业符合条件的资本性支出，依照国家规定允许在支出发生当期一次性税前扣除或者加速折旧和摊销。</p>
<p>对在合作区设立的旅游业、现代服务业、高新技术产业企业新增境外直接投资取得的所得，依照国家规定免征企业所得税。</p>
<p>在合作区工作的境内外高端人才和紧缺人才，其个人所得税负超过15%的部分，依照国家规定予以免征。</p>
<p>对在合作区工作的澳门居民，其个人所得税负超过澳门税负的部分，依照国家规定予以免征。</p>
<p>第五章  便利澳门居民生活就业</p>
<p>第三十八条  推动合作区深度对接澳门教育、医疗、社会服务、交通等民生公共服务和社会保障体系，为澳门居民在合作区学习、就业、创业、生活提供便利条件。</p>
<p>第三十九条  支持合作区完善在合作区就业、居住的澳门居民子女就学政策，建立衔接澳门的教育服务机制，推动与澳门学校的交流与合作，鼓励在合作区内开办澳门子弟学校、子弟班。</p>
<p>合作区普及学前教育，大力发展普惠性学前教育，加强优质公办学位建设，支持社会力量举办民办幼儿园。</p>
<p>在合作区就业、居住的澳门居民子女入学、入园，与横琴户籍生享有同等权利。</p>
<p>第四十条  支持合作区打造横琴澳门青年创业谷、中葡青年创新创业基地等载体，为澳门青年提供更多的创新创业空间。</p>
<p>广东省人民政府及其有关部门应当为澳门青年在合作区创新创业就业提供政策扶持，推动在合作区创新创业就业的澳门青年同步享受粤澳两地的扶持政策。</p>
<p>第四十一条  按照国家规定，具有澳门等境外执业资格的金融、建筑、规划、设计等领域专业人才，在符合行业监管要求条件下，经备案后在合作区提供服务，其境外从业经历可以视同境内从业经历。</p>
<p>探索符合条件的港澳和外籍医务人员在合作区便利执业。推动符合条件的外籍家政服务人员经备案可以在合作区内为澳门居民和境外高端人才、紧缺人才提供服务。</p>
<p>第四十二条  支持在合作区探索提供澳门模式的医疗、教育、广播电视、电影及社区服务等，营造衔接澳门的居住环境。</p>
<p>在合作区建设“澳门新街坊”等民生项目，拓展澳门居民优质生活空间。</p>
<p>第四十三条  鼓励澳门医疗卫生服务提供主体在合作区内以独资、合资或者合作方式设置医疗机构。</p>
<p>前款医疗机构可以经批准后在本医疗机构内使用临床急需、已在澳门上市的药品和特殊医学用途配方食品，以及使用临床急需、澳门公立医院已采购使用、具有临床应用先进性(大型医用设备除外)的医疗器械。</p>
<p>第四十四条  支持合作区衔接澳门养老服务标准及规范，提供多元化的长者照顾服务，建设医养结合的养老服务设施。</p>
<p>第四十五条  合作区应当与相邻地区开展区域应急合作，建立和完善信息通报制度和应急管理联动机制，共同做好突发事件区域联防联控相关工作。</p>
<p>推动粤澳在合作区共建区域医疗联合体和区域性医疗中心，联合应对公共卫生突发事件。</p>
<p>第四十六条  支持合作区建立与澳门社会服务合作机制，促进两地社区治理和服务融合发展。</p>
<p>支持符合条件的澳门社会服务团体依法在合作区内提供相应的社会服务。</p>
<p>中国籍澳门居民可以按照国家规定担任合作区社会组织成员或者负责人。</p>
<p>第六章  推动琴澳一体化发展</p>
<p>第四十七条  支持合作区构建与澳门一体化高水平开放的新体系，促进要素高效便捷流动，打造市场化法治化国际化营商环境。</p>
<p>第四十八条  按照国家有关规定，符合条件的货物及物品从澳门经“一线”免(保)税进入合作区。</p>
<p>对合作区和澳门之间经“一线”进出的货物(过境合作区货物除外)按照国家规定实施备案管理，简化申报程序和要素。</p>
<p>第四十九条 合作区与内地之间货物、物品、运输工具等应当经“二线”通道进出。</p>
<p>从合作区经“二线”通道进入内地的免(保)税货物，按照进口货物有关规定办理海关手续，依法征收关税和进口环节税。</p>
<p>对合作区内企业生产的不含进口料件或者含进口料件在合作区加工增值达到或者超过30%的货物，经“二线”通道进入内地按照国家规定免征进口关税。</p>
<p>从内地经“二线”通道进入合作区的有关货物视同出口，按照现行税收政策规定实行增值税和消费税退税，涉及出口关税应税商品的征收出口关税，并根据需要办理海关手续。</p>
<p>第五十条  推动在合作区开展动植物及其产品检验检疫改革创新试点，探索建立更为简便、优化的检验检疫模式。</p>
<p>第五十一条  合作区在“一线”按照规定实行合作查验、一次放行通关模式，依法实施卫生检疫。“二线”对人员进出不作限制。</p>
<p>推动琴澳口岸实施更大范围、更深层次的信息互换、执法互助、监管互认，全面提升通关便利化水平。</p>
<p>支持符合条件的澳门机动车辆免担保进入合作区。推动放开取得澳门机动车驾驶执照的澳门居民可以在合作区驾驶与准驾车型相符的机动车。</p>
<p>第五十二条  合作区实施更加开放的人员出入境政策，为境内外人员进出合作区创造更加便利的条件。在横琴口岸设立的签证机关为外国人进入合作区提供口岸签证便利。</p>
<p>合作区公安机关出入境管理机构可以受理、审批签发并制作外国人签证和停居留证件。对在合作区企业、高等学校、科研机构工作的符合条件的内地人员实行商务和人才签注备案制。</p>
<p>第五十三条  支持合作区建立高度便利的市场准入制度，按照国家规定实施合作区放宽市场准入特别措施，放宽各类投资者在合作区开展投资贸易的资质要求、持股比例、行业准入等限制。合作区简化政务服务流程，进一步整合审批资源，提高审批效率，降低审批成本。</p>
<p>支持合作区拓展国际贸易单一窗口功能，提高货物通关效率，促进跨境贸易便利化。</p>
<p>合作区推行与澳门商事登记跨境通办，推动建立与澳门商事登记信息共享互通机制。</p>
<p>第五十四条  支持合作区建立与其发展相适应的账户管理体系，推动合作区与澳门资金自由便利流动，建立适应高水平贸易投资自由化、便利化需要的跨境投融资管理制度。</p>
<p>鼓励合作区、澳门的保险机构合作开发跨境保险产品，提供跨境保险服务。</p>
<p>第五十五条  支持合作区在国家数据跨境传输安全管理制度框架下，开展数据跨境传输安全管理试点，建设固网接入国际互联网的绿色通道。</p>
<p>支持合作区、澳门相关高等学校、科研机构在确保个人信息和重要数据安全前提下，实现科学研究数据依法跨境互联互通。</p>
<p>第七章  法治保障</p>
<p>第五十六条  支持合作区加快扩大规则、规制、管理、标准等制度型开放，逐步构建民商事规则衔接澳门、接轨国际的制度体系。</p>
<p>第五十七条  合作区执行委员会、广东省派出机构根据改革发展需要，经合作区管理委员会同意，可以建议广东省人民代表大会及其常务委员会制定法规，或者建议珠海市人民代表大会及其常务委员会制定经济特区法规，在合作区内实施。</p>
<p>第五十八条  合作区执行委员会、广东省派出机构根据改革发展需要，可以建议广东省人民代表大会常务委员会、广东省人民政府在合作区暂时调整或者暂时停止适用有关广东省地方性法规、广东省政府规章的规定。</p>
<p>珠海市地方性法规、珠海市政府规章中有关规定不适应合作区发展的，合作区执行委员会、广东省派出机构可以提出调整或者停止该规定在合作区适用的建议。珠海市人民代表大会常务委员会、珠海市人民政府应当支持并按照程序予以办理。</p>
<p>第五十九条  合作区建立综合执法制度，经广东省人民政府同意，合作区执行委员会在职权范围内可以明确一个工作机构相对集中行使行政处罚权并向社会公布。</p>
<p>合作区执行委员会可以结合合作区改革创新实践需要，制定行政裁量权基准，规范行使行政裁量权。</p>
<p>合作区行政执法人员应当持中华人民共和国行政执法证开展行政执法工作。行政执法证核发、管理按照国家以及广东省有关规定执行，具体工作由合作区执行委员会组织实施。</p>
<p>第六十条  有关单位和个人对合作区执行委员会的工作机构、广东省人民政府派出机构的工作机构作出的行政行为不服的，可以分别向合作区执行委员会、广东省人民政府派出机构申请行政复议。</p>
<p>有关单位和个人对合作区执行委员会及其工作机构、广东省人民政府派出机构及其工作机构作出的行政行为不服的，可以依法向人民法院提起行政诉讼。</p>
<p>第六十一条  加强粤澳司法交流协作，推动在合作区建立完善国际商事审判、仲裁、调解等多元化商事纠纷解决机制。</p>
<p>鼓励合作区仲裁机构借鉴国际商事仲裁机构先进的管理体制和管理模式，建立国际通行商事仲裁机制，搭建琴澳仲裁合作平台。</p>
<p>鼓励在合作区依法开展国际商事调解。当事人达成的、具有给付内容的商事调解协议，经公证依法赋予强制执行效力或者经人民法院司法确认，可以向人民法院申请强制执行。</p>
<p>第六十二条  推动广东省、澳门两地的律师、公证、法律援助等法律服务业务融合发展。加快建设琴澳国际法务集聚区，优化涉外法律服务。支持在合作区成立律师协会，加强律师行业管理。</p>
<p>取得律师执业证书(粤港澳大湾区)的人员，按照国家规定在合作区内办理适用内地法律的部分民商事法律事务(含诉讼业务和非诉讼业务)。</p>
<p>澳门公证机构出具或者中国委托公证人(澳门)出具的民商事领域的公证文书，可以按照国家规定在合作区内使用。</p>
<p>澳门居民在合作区申请法律援助的，法律援助机构可以按照澳门有关司法援助的条件、范围等规定核查申请人的经济状况等。</p>
<p>第六十三条  支持在合作区依法设立域外法查明服务机构，提供包括澳门、葡语系国家(地区)在内的域外法查明服务。</p>
<p>第六十四条  合作区执行委员会应当加强对市场主体生产、经营活动的监管，完善市场主体信用监管制度，建立市场主体信用信息公示、信用评价制度。</p>
<p>第六十五条  合作区建立安全风险预警和防控体系，防范和化解重大风险。</p>
<p>合作区加强反洗钱、反恐怖融资、反逃税、反非法集资监管，对禁限管制、高风险商品等依法实施口岸联合查验和入市监管。广东省有关部门应当加强对合作区财税金融政策执行的监督检查。</p>
<p>广东省派出机构会同中央驻粤相关机构、合作区执行委员会建立分工协作、各尽其责的反走私综合治理工作机制，海关、边检、公安等部门综合运用稽查、核查、调查、缉私等监管手段，依法打击走私等违法犯罪活动。</p>
<p>第八章  附  则</p>
<p>第六十六条  本条例自2023年3月1日起施行。 <span>【编辑:田博群】 </span></p>
<hr>
